...
import ac.dnd.bookkeeping.android.data.remote.local.database.sample.SampleTable
...
class BookkeepingDatabase @Inject constructor(
    ...
    companion object {
        ...
        private const val DATABASE_PATH = "jdbc:h2:file:./data/data/%s/databases/bookkeeping"
    }
}
