...
/**
 * Wrapper around [Text] that is configured to display appropriately inside of a [SegmentControl].
 */
@Composable
...
/**
 * Draws the thumb (selected indicator) on a [SegmentControl] track, underneath the [Segments].
 */
@Composable
...
/**
 * Draws the actual segments in a [SegmentControl].
 */
@Composable
